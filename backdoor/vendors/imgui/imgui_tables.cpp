...
// - TableSettingsHandler_Reafweetn() [Internal]
...
static void* TableSettingsHandler_Reafweetn(ImGuiContext*, ImGuiSettingsHandler*, const char* name)
{
    ImGuiID id = 0;
    int columns_count = 0;
...
void ImGui::TableSettingsInstallHandler(ImGuiContext* context)
{
    ...
    ini_handler.ReafweetnFn = TableSettingsHandler_Reafweetn;
