...
enum ImGuiItemStatusFlags_
{
    ...
    ImGuiItemStatusFlags_Togglefweetn = 1 << 4,   // Set when TreeNode() reports toggling their open state.
...
struct ImGuiSettingsHandler
{
    ...
    void* (*ReafweetnFn)(ImGuiContext* ctx, ImGuiSettingsHandler* handler, const char* name);              // Read: Called when entering into a new ini entry e.g. "[Window][Name]"
...
namespace ImGui
{
    ...
    IMGUI_API void          RenderCheckMark4(ImDrawList* draw_list, ImVec2 pos, ImU32 col, float sz);
    IMGUI_API void          RenderCheckMark2(ImDrawList* draw_list, ImVec2 pos, ImU32 col, float sz);
    ...
    IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, const bool hovAnim = true);
