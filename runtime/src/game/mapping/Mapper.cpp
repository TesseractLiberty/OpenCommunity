...
namespace {
	...
	Mappings CreateVanillaMappings()
	{
		return {
			...
			{"net/minecraft/client/gui/GuiIngame", "net/minecraft/client/gui/GuiIngame"},
			{"net/minecraft/client/gui/GuiNewChat", "net/minecraft/client/gui/GuiNewChat"},
			{"net/minecraft/client/gui/GuiTextField", "net/minecraft/client/gui/GuiTextField"},
			...
			{"net/minecraft/util/ChatComponentText", "net/minecraft/util/ChatComponentText"},
	...
	void ApplyLunarMappings(Mappings& mappings)
	{
		ApplyMappings(mappings, {
			...
			{"guiSendChatMessage", "sendChatMessage"},
			{"guiSendChatMessageInternal", "sendChatMessage"},
			{"guiChatKeyTyped", "keyTyped"},
			{"inputField", "inputField"},
			{"getTextFieldText", "getText"},
			{"setTextFieldText", "setText"},
			{"displayGuiScreen", "displayGuiScreen"},
			{"getChatGUI", "getChatGUI"},
			...
			{"getStackDisplayName", "getDisplayName"},
	...
	void ApplySrgMappings(Mappings& mappings)
	{
		ApplyMappings(mappings, {
			...
			{"sendChatMessage", "func_71165_d"},
			{"guiSendChatMessage", "func_175275_f"},
			{"guiSendChatMessageInternal", "func_175281_b"},
			{"guiChatKeyTyped", "func_73869_a"},
			{"inputField", "field_146415_a"},
			{"getTextFieldText", "func_146179_b"},
			{"setTextFieldText", "func_146180_a"},
			{"displayGuiScreen", "func_147108_a"},
			{"getChatGUI", "func_146158_b"},
			{"printChatMessage", "func_146227_a"},
			{"onTick", "func_74507_a"},
			...
			{"getStackDisplayName", "func_82833_r"},
...
void Mapper::Initialize(const GameVersions version)
{
	...
	case BADLION: {
		g_Mappings = {
			...
			{ "clickMouse", "aw" },
			{ "sendChatMessage", "e" },
			{ "guiSendChatMessage", "f" },
			{ "guiSendChatMessageInternal", "b" },
			{ "guiChatKeyTyped", "a" },
			{ "inputField", "a" },
			{ "getTextFieldText", "b" },
			{ "setTextFieldText", "a" },
