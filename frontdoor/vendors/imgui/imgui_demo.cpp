    ...
    if (ImGui::TreeNode("Trees"))
    {
        ...
        if (ImGui::TreeNode("Advanced, with Selectable nodes"))
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                // To alter selection we use IsItemClicked() && !IsItemTogglefweetn(), so clicking on an arrow doesn't alter selection.
                ...
                if (i < 3)
                {
                    ...
                    if (ImGui::IsItemClicked() && !ImGui::IsItemTogglefweetn())
                        node_clicked = i;
